...
#' @param report A data frame containing the molecular report data generated by Formularity (Tolić et al, 2017, Analytical Chemistry)
#' @param ver The version of the ftmsRanalysis package to use. Supports "1.1.0" and "1.2.0". Default is "1.1.0".
...
molTrait <- function(report, ver = "1.1.0"){
  ...
  # ver <- packageVersion("ftmsRanalysis")
